import logging
import gateway.jsonchan
import gateway.ticker

from gateway.lib.crypto2crypto import CryptoTransportLayer
...
class LegacyModule:
    ...
    def __init__(self, settings):
        ...
        self._json_chan_handler = gateway.jsonchan.JsonChanHandler(self._p2p)
        self._ticker_handler = gateway.ticker.TickerHandler()
